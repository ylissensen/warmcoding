...
<div class="wrap">
    <div class="container">
        <h1>注册新用户</h1>
        <form method="post">
            <input type="text" name="user" id="user" placeholder="请输入你的用户名"/>
            <input type="password" name="password" id="password" placeholder="请输入您的密码" />
            <input type="password" name="password1" id="password1" placeholder="请再次输入您的密码" />
            <input type="button" onclick="applyButton()" id="button" value="完成"/>
            <p class="change_link" align="center">
                <span class="text">已经有帐户？</span>
                <a href="${pageContext.request.contextPath }/JSP/login.jsp" class="to_login"> 点击这里登陆</a>
            </p>
        </form>
    </div>
    <ul>
...
<script type="text/javascript">
       function applyButton(){
			$.ajax({
	    		...
	    		data: {user:$('#user').val(),password:$('#password').val(),password1:$('#password1').val()},	
	    		dataType:"json",
	    	    	 ...
	    	    	 /*  layer.open({
	    	    	  ...
	    	    	  window.location.href = "${pageContext.request.contextPath}/html/login.jsp";
	    	    	   ...
	    	    	   layer.open({
		    	   			...
		    	   			area: ['320px', '160px'],
		    	   			shadeClose: true, //点击遮罩关闭
		    	   			content: '\<\div style="font-size:18px; padding:50px; background-color:#ebf6f7;">sever is wrong \<\/div>'
		    	   			});
	    	       } else if(info == -2){
	    	    	   layer.open({
		    	   			type: 1,
		    	   			...
		    	   			area: ['320px', '160px'],
		    	   			shadeClose: true, //点击遮罩关闭
		    	   			content: '\<\div style="font-size:18px; padding:50px; background-color:#ebf6f7;">the name has been used \<\/div>'
		    	   			});
	    	       } else if(info = -3){
	    	    	   layer.open({
		    	   			type: 1,
		    	   			...
		    	   			area: ['320px', '160px'],
		    	   			shadeClose: true, //点击遮罩关闭
		    	   			content: '\<\div style="font-size:18px; padding:50px; background-color:#ebf6f7;">your password identification is wrong \<\/div>'
		    	   			});
	    	       }
